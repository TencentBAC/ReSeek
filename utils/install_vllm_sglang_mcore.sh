...
if [ $USE_SGLANG -eq 1 ]; then
    pip install "sglang[all]==0.4.6.post1" --no-cache-dir && pip install torch-memory-saver --no-cache-dir #--find-links https://flashinfer.ai/whl/cu124/torch2.6/flashinfer-python 
fi
