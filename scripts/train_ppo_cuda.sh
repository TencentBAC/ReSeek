...
export EXPERIMENT_NAME=ReSeekReSeek-ppo-qwen2.5-3b-em-s3-instruct_v0.14_1_cuda
set -x
...
TRAIN_DATA_DIR=${DATA_DIR}/ReSeek_processed_direct_v0.14
TEST_DATA_DIR=${DATA_DIR}/ReSeek_processed_direct_v0.14
