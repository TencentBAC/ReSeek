...
export EXPERIMENT_NAME=ReSeekReSeek-ppo-qwen7b-em-s3-instruct_v0.14_1
set -x
...
TRAIN_DATA_DIR=${DATA_DIR}/ReSeek_processed_direct_v0.14 #${DATA_DIR}/ReSeek_processed_direct_v0.2
TEST_DATA_DIR=${DATA_DIR}/ReSeek_processed_direct_v0.14 #${DATA_DIR}/ReSeek_processed_direct_v0.2
